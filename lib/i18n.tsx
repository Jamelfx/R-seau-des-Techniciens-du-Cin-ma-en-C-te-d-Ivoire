...
const translations = {
  fr: {
    ...
    "sitech.page.heroSubtitle": "Le plus grand rassemblement des professionnels de l'audiovisuel en Afrique de l'Ouest",
    "sitech.page.about": "À Propos",
    "sitech.page.aboutText": "Le SITECH (Salon International des Technologies de l'Image et du Son) est l'événement phare de RETECHCI. Pendant 3 jours, professionnels, étudiants et passionnés se réunissent pour découvrir les dernières innovations technologiques, participer à des masterclasses exclusives et networker avec l'ensemble de l'écosystème audiovisuel ouest-africain.",
    "sitech.page.highlights": "Points Forts",
    "sitech.page.highlight1": "Expositions Technologiques",
    "sitech.page.highlight1Desc": "Découvrez les derniers équipements des plus grandes marques mondiales",
    "sitech.page.highlight2": "Masterclasses",
    "sitech.page.highlight2Desc": "Apprenez des meilleurs professionnels de l'industrie",
    "sitech.page.highlight3": "Networking",
    "sitech.page.highlight3Desc": "Rencontrez producteurs, réalisateurs et techniciens de toute l'Afrique",
    "sitech.page.highlight4": "Projections",
    "sitech.page.highlight4Desc": "Avant-premières et films primés du cinéma africain",
    "sitech.page.schedule": "Programme",
    "sitech.page.day1": "Jour 1 - 15 Déc",
    "sitech.page.day2": "Jour 2 - 16 Déc",
    "sitech.page.day3": "Jour 3 - 17 Déc",
    "sitech.page.location": "Lieu",
    "sitech.page.locationName": "Sofitel Abidjan Hôtel Ivoire",
    "sitech.page.locationAddress": "Boulevard Hassan II, Cocody, Abidjan",
    "sitech.page.register": "S'inscrire maintenant",
    "sitech.page.pricing": "Tarifs",
    "sitech.page.student": "Étudiant",
    "sitech.page.professional": "Professionnel",
    "sitech.page.vip": "VIP",
    "sitech.page.perPerson": "/personne",
    "sitech.page.includes": "Inclus",
    "sitech.page.access3days": "Accès 3 jours",
    "sitech.page.masterclasses": "Masterclasses",
    "sitech.page.networking": "Soirées networking",
    "sitech.page.certificate": "Certificat de participation",
    "sitech.page.vipLounge": "Accès lounge VIP",
    "sitech.page.speakers": "Intervenants Confirmés",
  ...
  en: {
    ...
    "sitech.page.heroSubtitle": "The largest gathering of audiovisual professionals in West Africa",
    "sitech.page.about": "About",
    "sitech.page.aboutText": "SITECH (International Exhibition of Image and Sound Technologies) is RETECHCI's flagship event. For 3 days, professionals, students and enthusiasts gather to discover the latest technological innovations, participate in exclusive masterclasses and network with the entire West African audiovisual ecosystem.",
    "sitech.page.highlights": "Highlights",
    "sitech.page.highlight1": "Technology Exhibitions",
    "sitech.page.highlight1Desc": "Discover the latest equipment from the world's leading brands",
    "sitech.page.highlight2": "Masterclasses",
    "sitech.page.highlight2Desc": "Learn from the best industry professionals",
    "sitech.page.highlight3": "Networking",
    "sitech.page.highlight3Desc": "Meet producers, directors and technicians from all over Africa",
    "sitech.page.highlight4": "Screenings",
    "sitech.page.highlight4Desc": "Premieres and award-winning African cinema films",
    "sitech.page.schedule": "Schedule",
    "sitech.page.day1": "Day 1 - Dec 15",
    "sitech.page.day2": "Day 2 - Dec 16",
    "sitech.page.day3": "Day 3 - Dec 17",
    "sitech.page.location": "Location",
    "sitech.page.locationName": "Sofitel Abidjan Hôtel Ivoire",
    "sitech.page.locationAddress": "Boulevard Hassan II, Cocody, Abidjan",
    "sitech.page.register": "Register now",
    "sitech.page.pricing": "Pricing",
    "sitech.page.student": "Student",
    "sitech.page.professional": "Professional",
    "sitech.page.vip": "VIP",
    "sitech.page.perPerson": "/person",
    "sitech.page.includes": "Includes",
    "sitech.page.access3days": "3-day access",
    "sitech.page.masterclasses": "Masterclasses",
    "sitech.page.networking": "Networking evenings",
    "sitech.page.certificate": "Certificate of participation",
    "sitech.page.vipLounge": "VIP lounge access",
    "sitech.page.speakers": "Confirmed Speakers",
